...
void DialogVPNSettings::on_troubleshooting_clicked() {
    ...
    QMessageBox msg(
        ...
        // ARSMAG: ссылка на документацию Nekoray (matsuridayo.github.io) убрана —
        // это документация чужого проекта, описывающая чужие настройки (решение 10, п.5).
        // Вернуть строку со ссылкой, когда появится своя страница.
